...
void Vsingen___024root__trace_chg_0_sub_0(Vsingen___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vsingen___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsingen___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vsingen___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vsingen___024root__trace_chg_0_sub_0(Vsingen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vsingen__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsingen___024root__trace_chg_0_sub_0\n"); );
    ...
    bufp->chgCData(oldp+5,(vlSelfRef.singen__DOT__Addr),8);
}
